...
COCO_OOD_VIS_THING_CLASSES = ['person', 'bicycle', 'car', 'motorcycle', 'airplane',
...
VIS_THING_CLASSES = ['airplane', 'bear', 'bird', 'boat', 'car', 'cat', 'cow', 'deer', 'dog', 'duck',
...
# MAP VIS to COCO contiguous id to be used for inference on COCO for models
# trained on VIS.
#VIS_TO_COCO_CONTIGUOUS_ID = dict(ChainMap(
    #*[{VIS_THING_CLASSES.index(coco_thing_class): COCO_OOD_VIS_THING_CLASSES.index(coco_thing_class)} for coco_thing_class in
      #COCO_OOD_VIS_THING_CLASSES]))
# import ipdb; ipdb.set_trace()

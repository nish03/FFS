...
ood_data = pickle.load(open('./data/configs/VIS/FFS_regnet/random_seed' +'_' + str(args.seed)  +'/inference/nu_bdd_ood/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))

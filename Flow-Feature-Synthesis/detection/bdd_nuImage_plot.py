...
ood_data = pickle.load(open('./data/configs/BDD100k/FFS_regnet/random_seed' +'_'+str(args.seed)  +'/inference/coco_2017_val_ood_wrt_bdd/standard_nms/corruption_level_0/probabilistic_scoring_res_odd_'+str(args.thres)+'.pkl', 'rb'))
